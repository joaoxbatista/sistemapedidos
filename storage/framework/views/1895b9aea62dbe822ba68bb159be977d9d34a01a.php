...
<a href="<?php echo e(route('admin-dashboard.products')); ?>" class="btn btn-default">Voltar</a><br><br>
...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<?php echo e(Form::open(['method' => 'post', 'route' => 'admin-dashboard.categories.store'])); ?>
