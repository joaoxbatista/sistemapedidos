...
<div class="panel panel-default">
	...
	<div class="panel-body">
		...
		<div class="form-group col-md-3">
			...
			<?php echo e(Form::text('cpf', $client->cpf, ['id' => 'cpf','class' => 'form-control', 'required' => true])); ?>
		...
		<div class="form-group col-md-3">
			...
			<?php echo e(Form::text('cnpj', $client->cnpj, ['id' => 'cnpj', 'class' => 'form-control'])); ?>
...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<div class="form-group col-md-4">
			...
			<?php echo e(Form::text('phone', $client->phone, ['id' => 'phone', 'class' => 'form-control', 'required' => true])); ?>
...
<div class="panel panel-default">
	...
	<div class="panel-body">
		...
		<div class="form-group col-md-2">
			...
			<?php echo e(Form::text('cep', $client->cep, ['id' => 'cep', 'class' => 'form-control'])); ?>
