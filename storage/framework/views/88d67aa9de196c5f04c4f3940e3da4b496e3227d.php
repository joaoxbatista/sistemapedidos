...
<?php $__env->startSection('content'); ?>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="col-md-2">
                <h4>Vendas</h4>
                <?php if($saller->sales != null): ?>
                    <p><?php echo e($saller->sales); ?></p>
                <?php else: ?>
            ...
            <div class="col-md-2">
                <h4>Pagamento</h4>
                <?php if($saller->payment != null): ?>
                    <p>R$ <?php echo e($saller->payment); ?></p>
                <?php else: ?>
        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <?php echo e(Form::email('email', $saller->email, ['class' => 'form-control'])); ?>
