    ...
    <div id="side-menu">
        ...
        <div id="content-side-menu">
            ...
            <div class="group-menu">
                ...
                <nav>
                    <li><a href="<?php echo e(route('saller.profile')); ?>"><i class="fa fa-user"></i> Profile</a></li>
                    <li><a href="<?php echo e(route('saller.logout')); ?>"><i class="fa fa-power-off"></i>Sair</a></li>
                </nav>
            </div>
