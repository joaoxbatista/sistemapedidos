...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-3 well">
            <p>Itens vendidos <span class="label label-primary">{{ App\Models\Order::sallerItems() }}</span></p>
        </div>
        ...
        <div class="col-md-3 well">
            <p>Vendedores <span class="label label-primary">{{ App\Models\Saller::count() }}</span></p>
        </div>
