...
@section('content')
<a href="{{ route('admin-dashboard.products') }}" class="btn btn-default">Voltar</a>
<a href="{{ route('admin-dashboard.categories.create') }}" class="btn btn-success">Nova Categoria</a>
<a href="{{ route('admin-dashboard.providers.create') }}" class="btn btn-success">Novo Fornecedor</a><br><br>
...
<div class="panel panel-default">
	...
	<div class="panel-body">
		{{ Form::open(['method' => 'post', 'route' => 'admin-dashboard.products.store', 'files' => true])}}
		<div class="row">
