	...
	<div class="hb-order-create">
		<div class="card">
			<div class="content">
				...
				<div id="steps">
					<div class="row">
						<div class="col-md-3 col-sm-12">
							<button class="btn btn-info btn-block" v-show="fase > 0" @click="backStep"> <i class="fa fa-arrow-left"></i> Anterior</button>
						</div>
						...
						<div class="col-md-3 col-sm-12">
							<button class="btn btn-fill btn-info btn-block" v-show="fase < 5 && cart.item_quantity > 0" @click="nextStep"> <i class="fa fa-arrow-right"></i> Próximo</button>
						</div>
					</div>
				</div>
				...
				<hb-order-cart-payment-form v-show="fase == 3"></hb-order-cart-payment-form>

 				<hb-order-cart-delivery v-show="fase == 4"></hb-order-cart-delivery>
			</div>
		</div>
	</div>
